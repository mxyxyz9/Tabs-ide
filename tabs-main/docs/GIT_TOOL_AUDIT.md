...
| Review interaction       | Comments, approve/request-changes, reviewer/label edits, provider-backed inline threads, plus separate local AI review | Inline annotations, comments, reactions, reviewer selection, Markdown editing | Comments, Markdown, review timeline and code inspection         | Reactions and rich Markdown remain                       |
...
2. **Finish review parity:** reactions, rich Markdown editing, and direct diff-line selection; provider-backed inline discussions, replies, comments, review submission, and reviewer management already work.
