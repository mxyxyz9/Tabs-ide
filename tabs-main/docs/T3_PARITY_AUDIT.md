...
| Capability | T3 Implementation & Files | Tabs Equivalent & Implementation | Status | Evidence & Test Suite | Implementing Commits |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Browser Session Importer** | Session & cookie extractor | `apps/desktop/src/browserImport/BrowserSessionImporter.ts`, extracts cookies, localStorage from system browsers | Complete | `BrowserSessionImporter.test.ts` (3 tests) verifies domain filtering and cookie normalization | `83ab7dda` |
...
| **Domain Whitelist & Privacy Safeguards** | Configurable domain filtering | `apps/desktop/src/browserImport/BrowserSessionImporter.ts`, filters sensitive domains and prompts for import approval | Complete | Security tests verify rejection of unauthorized domain cookies | `83ab7dda` |
