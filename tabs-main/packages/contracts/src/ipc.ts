...
export interface DesktopBridge {
  ...
  getBrowserSessionState: (input: DesktopBrowserHostControlInput) => Promise<DesktopBrowserSessionState>;
  ...
  onBrowserSessionState: (
    listener: (state: DesktopBrowserSessionState) => void,
  ) => () => void;
}
