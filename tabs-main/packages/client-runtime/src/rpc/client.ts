import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@tabs/contracts";
...
}>("@tabs/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
}>("@tabs/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
