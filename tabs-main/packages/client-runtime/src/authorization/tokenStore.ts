...
import { RelayManagedEndpoint } from "@tabs/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@tabs/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@tabs/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
