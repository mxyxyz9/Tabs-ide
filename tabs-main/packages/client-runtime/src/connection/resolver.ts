import type { AuthClientPresentationMetadata } from "@tabs/contracts";
import { RelayEnvironmentConnectScope } from "@tabs/contracts/relay";
...
>()("@tabs/client-runtime/connection/resolver/ConnectionResolver") {}
