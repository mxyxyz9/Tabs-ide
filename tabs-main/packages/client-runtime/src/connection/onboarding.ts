import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@tabs/contracts";
...
>()("@tabs/client-runtime/connection/onboarding/ConnectionOnboarding") {}
...
export const make = Effect.gen(function* () {
  ...
  return ConnectionOnboarding.of({
    registerPairing: (input: Parameters<ConnectionOnboarding["Service"]["registerPairing"]>[0]) =>
