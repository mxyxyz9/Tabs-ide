...
>()("@tabs/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@tabs/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@tabs/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@tabs/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
