...
import { encodeOAuthScope, oauthScopeSetEquals } from "@tabs/shared/oauthScope";
import { decodeRelayJwt } from "@tabs/shared/relayJwt";
import { withRelayClientTracing } from "@tabs/shared/relayTracing";
...
>()("@tabs/client-runtime/relay/managedRelay/ManagedRelayDpopSigner") {}
...
>()("@tabs/client-runtime/relay/managedRelay/ManagedRelayClient") {}
