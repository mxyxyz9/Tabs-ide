// This file mostly exists because we want dev mode to say "Tabs (Dev)" instead of "electron"
...
const isDevelopment = Boolean(
  process.env.VITE_DEV_SERVER_URL || process.argv[1]?.endsWith("dev-electron.mjs"),
);
const APP_BASE_NAME = "Tabs";
const APP_DISPLAY_NAME = isDevelopment ? `${APP_BASE_NAME} (Dev)` : APP_BASE_NAME;
const APP_BUNDLE_ID = isDevelopment ? "com.tabs.app.dev" : "com.tabs.app";
