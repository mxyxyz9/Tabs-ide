...
import { prepareBrowserBrandAssets } from "../../../scripts/lib/icon-assets.ts";
  ...
  (config) =>
    Effect.gen(function* () {
      ...
      if (yield* fs.exists(webDist)) {
        ...
        yield* prepareBrowserBrandAssets(clientTarget, repoRoot);
...
const cli = Command.make("cli").pipe(
  Command.withDescription("Tabs server build & publish CLI."),
