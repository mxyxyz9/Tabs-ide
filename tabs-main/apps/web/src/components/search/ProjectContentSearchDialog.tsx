...
import type { ProjectContentMatch } from "@tabs/contracts";
...
import { useProjectContentSearch } from "~/state/projectContentSearch";
...
function OpenContentSearchDialog(props: {
  ...
  const openMatch = (match: ProjectContentMatch) => {
    ...
    useWorkspaceShellStore
      .getState()
      .setCodeFocusedPath(target.projectId, match.path, match.lineNumber);
