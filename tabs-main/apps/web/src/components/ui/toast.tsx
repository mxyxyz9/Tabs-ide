...
function DismissToastButton({ onClick }: { onClick: () => void }) {
  return (
    <Button
        ...
        {visibleToastLayout.items.map(({ toast, visibleIndex, offsetY }) => {
          ...
          return (
            ...
            >
              ...
              <Toast.Content
                className={cn(
                  "pointer-events-auto relative flex items-center justify-between gap-1.5 overflow-hidden px-3.5 py-3 pr-8 text-sm transition-opacity duration-250 data-expanded:opacity-100",
