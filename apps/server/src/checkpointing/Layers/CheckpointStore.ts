...
import { CheckpointRef } from "@tabs/contracts";
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = (input) =>
    Effect.gen(function* () {
      ...
      yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "tabs-fs-checkpoint-" }),
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "Tabs",
              GIT_AUTHOR_EMAIL: "tabs@users.noreply.github.com",
              GIT_COMMITTER_NAME: "Tabs",
              GIT_COMMITTER_EMAIL: "tabs@users.noreply.github.com",
            };
            ...
            const message = `tabs checkpoint ref=${input.checkpointRef}`;
